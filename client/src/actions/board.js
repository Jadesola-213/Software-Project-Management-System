...
export const deleteBoards = (id) => async (dispatch) => {
  try {
    const res = await axios.post(`/api/boards/delete/${id}`);
...
export const editList = (listId, formData) => async (dispatch) => {
  try {
    const body = JSON.stringify(formData);
    const res = await axios.post(`/api/lists/edit/${listId}`, body, config);
...
//Edit list 2
export const editList2 = (listId, formData) => async (dispatch) => {
  try {
    const body = JSON.stringify(formData);
    const res = await axios.post(`/api/lists/edit2/${listId}`, body, config);
...
export const deleteList = (listId) => async (dispatch) => {
  try {
    const res = await axios.patch(`/api/lists/delete/${listId}`);
